...
prijs = float(input("Hoeveel euro bent u bereid mee te betalen? "))

if drukken > 100 and spijker > 10 and prijs >= deel:
    print("Je bent in aanmerking gekomen voor de rol 'Beer' in het team.")

if iq > 130 and kast < 300 and prijs >= deel:
    print("Je bent in aanmerking gekomen voor de rol 'Vos' in het team")

if sloot > 3 and vuur < 60 and prijs >= deel:
    print("Je bent in aanmerking gekomen voor de rol 'Bever' in het team")

if paddestoelen > 10 and kruiden > 20 and mos == "W" and zuiveren == "J" and prijs >= deel:
